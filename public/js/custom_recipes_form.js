...
function addInstructionField () {
    ...
    let childCount = instructionsSection.childElementCount;
    let newInstructionNum = Number(childCount) - 1;
    ...
    instructionTextArea.setAttribute('name',`instruction-${newInstructionNum}-text`)
    instructionTextArea.setAttribute('id',`instruction-${newInstructionNum}-text`)
